...
3. เลือกไฟล์ที่มีคอลัมน์:
   ...
   - `categories`
   - `quantity` (ถ้ามี)
4. เปิดตัวเลือก **นำเข้าเฉพาะบาร์โค้ดขึ้นต้น 885** เมื่อต้องการลดขนาดข้อมูล
5. กด **เริ่มนำเข้า**
...
เลขขึ้นต้น `885` คือ prefix ที่จัดสรรโดย GS1 Thailand แต่ไม่ใช่หลักฐานว่าสินค้าผลิตในประเทศไทย
